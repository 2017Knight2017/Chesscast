...
export const ChessPreview = ({ match, isEmbedded }: { match: Match, isEmbedded?: boolean }) => {
	...
	const wrapperProps = isEmbedded ? {} : { href: `/watch/${match.id}?paraboards` };
	...
	return (
		<Wrapper {...(wrapperProps as any)} className="relative aspect-square w-full bg-stone-800 p-2 flex flex-col justify-between rounded">
