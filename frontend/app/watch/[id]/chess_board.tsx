		...
		>
			...
			{isAuthPopupShown && setIsAuthPopupShown && (
				<button onClick={() => setIsAuthPopupShown(false)}>
					<h3 className="absolute -bottom-8 left-0 px-3 py-1 bg-stone-600 text-orange-200 text-xs font-bold uppercase tracking-[0.2em] rounded-b-sm border-l-3 border-oak-light shadow-lg backdrop-blur-sm hover:cursor-pointer">
					    × Login to analyze!
					</h3>
				</button>
			)}
