...
export function BackToLiveButton() {
	...
	return (
		<button
			...
			className="flex items-center gap-2 px-4 py-2 bg-oak-light hover:bg-oak text-stone-900 text-sm font-bold tracking-widest uppercase rounded transition-colors border border-oak-dark/50 ring-1 ring-inset ring-white/20 shadow-sm"
		>
